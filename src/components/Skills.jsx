  ...
  return (
    <section className="container py-16">
      ...
      <Marquee speed={50} gradient={true} pauseOnHover={true} className="mt-8">
        ...
        <img src={jsSVG} alt="JavaScript" className="w-16 h-16 mx-8" title="JavaScript" />
        <img src={reactSVG} alt="React" className="w-16 h-16 mx-8" title="React" />
        <img src={tailwindSVG} alt="Tailwind CSS" className="w-16 h-16 mx-8" title="Tailwind CSS" />
        <img src={viteSVG} alt="Vite" className="w-16 h-16 mx-8" title="Vite" />
        <img src={nodeSVG} alt="Node.js" className="w-16 h-16 mx-8" title="Node.js" />
        <img src={gitSVG} alt="Git" className="w-16 h-16 mx-8" title="Git" />
        <img src={gitHubSVG} alt="GitHub" className="w-16 h-16 mx-8" title="GitHub" />
        <img src={vercelSVG} alt="Vercel" className="w-16 h-16 mx-8" title="Vercel" />
        <img src={figmaSVG} alt="Figma" className="w-16 h-16 mx-8" title="Figma" />
